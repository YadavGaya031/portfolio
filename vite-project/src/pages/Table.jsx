...
const Table = () => {
  ...
  return (
    <>
      <div className="min-h-screen w-full bg-[#222222] px-20 py-10">
        ...
        {tableData.map(({ year, title, type, link }, index) => (
          ...
          >
            ...
            {/* Row */}
            <div className="relative z-10 flex text-white text-4xl font-bold py-5 px-6 transition-colors duration-500 group-hover:text-black">
