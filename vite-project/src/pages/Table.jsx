...
const Table = () => {
  ...
  return (
    <>
      <div className="h-auto w-full bg-[#222222] px-20 py-10">
        ...
        {tableData.map(({ year, title, type, link }, index) => (
          ...
          >
            ...
            {/* Row */}
            <div className="relative z-10 flex text-white text-2xl md:text:8xl font-bold py-5 px-6 transition-colors duration-500 group-hover:text-black">
